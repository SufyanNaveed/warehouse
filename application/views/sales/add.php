            ...
            <div class="box">
                  ...
                  -->
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" id="delivery_person_id" name="delivery_person_id" style="width: 100%;">
                          <option value=""><?php echo $this->lang->line('product_select'); ?></option>
                          <?php  
                            foreach ($delivery_person as $row) {
                          ?>
                              <option value="<?=$row->id?>"><?=$row->first_name.' '.$row->last_name?></option>
                          <?php
                            }
                        ...
                        <span class="validation-color" id="err_delivery_person_id"><?php echo form_error('delivery_person_id');?></span>
                      </div>
                    </div>
              ...
              <div class="box-body product_listing">
                <div class="row">
                  <div class="col-sm-12 ">
                    <div class="well">
                      <span>Id - Product Code - Product Name - Batch - Quantity</span>
                      <div class="row">
                      ...
                      <table class="table items table-striped table-bordered table-condensed table-hover product_table" name="product_data" id="product_data">
                        <thead>
                          <tr>
                            ...
                            <th class="span2" width="8%"><?php echo $this->lang->line('product_unit'); ?></th>
                            <th class="span2" width="8%">Qty</th>
                            <th class="span2" width="8%"><?php echo $this->lang->line('product_price'); ?></th>
                            ...
                            <th class="span2" width="8%">IGST</th>
                            <th class="span2" width="8%">CGST</th>
                            <th class="span2" width="8%">SGST</th>
                            <th class="span2" width="5%">Inclusive ?</th>
                            <th class="span2" width="20%"><?php echo $this->lang->line('purchase_total'); ?></th>
                          </tr>
                        </thead>
                    ...
                    $.ajax({
                      ...
                      success: function(data){
                          ...
                          for(var i = 0; i < data.length; ++i) {
                              suggestions.push(data[i].wp_id+' - '+data[i].code+' - '+data[i].name+' - '+data[i].batch+' - '+data[i].wp_quantity+' qty');
                              mapping[data[i].wp_id] = data[i].wp_id;
                              //alert([data[i].code]);
                          }
                          suggest(suggestions);
                        }
      ...
      $("table.product_table").find('input[name^="product_id"]').each(function () {
            ...
            if(flag == 0){
              ...
              cols += "<td>"
                      ...
                      +"</td>";
              cols += "<td>"+data[0].batch+"</td>";
              cols += "<td>"+data[0].expiry+"</td>";
              cols += "<td>"+data[0].unit+"</td>";
              cols += "<td>"
                      +"<input type='number' class='form-control text-center' value='0' data-rule='quantity' name='qty"+ counter +"' id='qty"+ counter +"' min='1' max='"++"'>" 
              ...
              $('#err_product').text('Product Already Added. Please increase the quantity if you want to add same product.').animate({opacity: '0.0'}, 5000).animate({opacity: '0.0'}, 4000).animate({opacity: '1.0'}, 5000);
            }
    }
