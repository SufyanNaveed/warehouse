        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title" style="font-weight: bold;">
              <?php 
                if(isset($data[0]->biller_first_name)){
                  echo $data[0]->biller_first_name." ".$data[0]->biller_last_name;
                } 
              ?>
          </div>
          <!-- /.box-header -->
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        <td><a href="<?php echo base_url('sales/customerView/').$row->customer_id; ?>"><?php echo $row->customer_first_name." ".$row->customer_last_name; ?></a></td>
                      <?php
                        }
                        else{
                      ?>
