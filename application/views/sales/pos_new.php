		...
		<tr>
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tr>
						<td style="font-size: 11px; padding-left: 2px; padding-right: 2px;" colspan="5" align="right">IGST</td>
						<td style="font-size: 11px; padding-left: 2px; padding-right: 2px;" align="right"><?php echo $igst; ?></td>
					</tr>					
					<tr>
						<td style="font-size: 11px; padding-left: 2px; padding-right: 2px;" colspan="5" align="right">Shipping Charge</td>
						<td style="font-size: 11px; padding-left: 2px; padding-right: 2px;" align="right"><?php echo $data[0]->shipping_charge; ?></td>
					</tr>					
					<tr>
