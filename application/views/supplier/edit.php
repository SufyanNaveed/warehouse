      ...
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><!-- Add Supplier -->
            <?php echo $this->lang->line('supplier_edit'); ?>
          </li>
        </ol>
      </h5>    
    </section>
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><!-- Add New Supplier -->
                <?php echo $this->lang->line('supplier_btn_edit'); ?>
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('supplier/edit');?>">
                  <div class="col-md-6">
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <!-- <input type="hidden" id="state_code" name="state_code" value="<?php echo set_value('state_code',$data->state_code); ?>"> -->
