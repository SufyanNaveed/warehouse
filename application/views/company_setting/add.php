              ...
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('company_setting/add');?>" encType="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="drug_licence_number">Drug Licence Number ( Wholesale )</label>
                      <input type="text" class="form-control" id="drug_licence_number" name="drug_licence_number" value="<?php if(isset($data[0]->drug_licence_number)){ echo $data[0]->drug_licence_number; }?>" autocomplite="off">
                      <span class="validation-color" id="err_drug_licence_number"><?php echo form_error('drug_licence_number'); ?></span>
                    </div>
                    <div class="form-group">
                      <label for="drug_licence_number1">Drug Licence Number ( Retail )</label>
                      <input type="text" class="form-control" id="drug_licence_number1" name="drug_licence_number1" value="<?php if(isset($data[0]->drug_licence_number1)){ echo $data[0]->drug_licence_number1; }?>" autocomplite="off">
                      <span class="validation-color" id="err_drug_licence_number1"><?php echo form_error('drug_licence_number1'); ?></span>
                    </div>
                  <div class="form-group">
