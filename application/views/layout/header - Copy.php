  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php if($this->uri->segment(1)=='accountgroup' || $this->uri->segment(1)=='ledger' || $this->uri->segment(1)=='credit_debit_note' || $this->uri->segment(1)=='gst_return' || $this->uri->segment(1)=='bank_account'){ echo 'active'; } ?>">
          <a href="#">
