...
<body>
	<table width="670px" border="1" cellspacing="0" style="border: 0px solid black; border-collapse: collapse;" class="table" cellpadding="2">
		<tr>
			<td colspan="6" style="border: 0px;text-align: right;">Sales Return Receipt</td>
		...
		<tr style="font-size: 13px;">
			...
			<td valign="top" colspan="4" style="font-size: 13px;">
				Sales Invoice No<br>
				<p style="font-size: 13px;font-weight:bold"><?php if(isset($data[0]->sales_invoice_number)){echo $data[0]->sales_invoice_number;}?></p>
			</td>
		</tr>
		<tr>
			...
			<td colspan="5" valign="top" style="padding: 10px;">
				...
				<span style="font-size: 12px;"><?php if(isset($data[0]->customer_name)){echo $data[0]->customer_name."<br/>"; }?></span>
				<span style="font-size: 11px;"><?php if(isset($data[0]->shipping_address)){echo $data[0]->shipping_address."<br/>"; }?></span>
				<span style="font-size: 11px;"><?php if(isset($data[0]->shipping_city)){echo $data[0]->shipping_city."<br/>"; }?></span>
				<span style="font-size: 11px;"><?php if(isset($data[0]->shipping_state)){echo $data[0]->shipping_state."<br/>"; }?></span>
			</td>
		...
		<tr>
			...
			<tr>
				...
				<td class="fontS" colspan="2" width="200px"><?php echo $value->name; ?><br>HSN:<?php echo $value->hsn_sac_code; ?></td>
			...
			<tr>
				...
				<td align="center" class="fontS" colspan="2">
					<?php
						echo $data[0]->total-$data[0]->tax_value-$data[0]->flat_discount;
					?>	
				</td>
				<td align="right" class="fontS">
					<?php echo $igst;?>	
			...
			<tr>
				...
				<td align="right" colspan="2" class="fontH"><?php echo round($tot+$igst+$cgst+$sgst-$data[0]->flat_discount); ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="right" colspan="2" class="fontH">
					<?php
						echo round($tot+$igst+$cgst+$sgst-$data[0]->paid_amount-$data[0]->flat_discount);
					?>
				</td>
			</tr>
        <tr>
        	<td colspan="7" valign="top" style="border-bottom: 0px;font-size: 13px;">
        		...
        		<b> INR <?php echo $this->numbertowords->convert_number(round($tot+$igst+$cgst+$sgst-$data[0]->paid_amount-$data[0]->flat_discount)); ?> Only</b><br/>
        	</td>
        	<td colspan="7" valign="top" style="border-bottom: 0px;font-size: 13px;">
