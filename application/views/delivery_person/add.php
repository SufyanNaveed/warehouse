      ...
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><!-- Add Supplier -->
            <?php echo $this->lang->line('delivery_person_add'); ?>
          </li>
        </ol>
      </h5>    
    </section>
      ...
      <!-- right column -->
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('delivery_person/add');?>">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="supplier_name"><!-- Supplier Name -->
                           <?php echo $this->lang->line('add_delivery_person_cname'); ?>
                    ...
                    <div class="form-group">
                      <label for="company">
                          <?php echo $this->lang->line('add_delivery_person_compname'); ?> 
                      </label>
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <input type="hidden" id="role_id" name="role_id" value="22">
                    <!-- <input type="hidden" id="state_code" name="state_code" value="<?php echo set_value('state_code'); ?>"> -->
