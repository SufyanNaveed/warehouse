...
class Sales extends MY_Controller
{
	...
	*/
	public function add()
	{
		...
		else
		{
			...
			$data['delivery_person'] 	= $this->user_model->get_user_records_by_role("delivery_person"); 
	...
	*/
	...
	public function getBarcodeProducts($term,$warehouse_id){
		...
		exit;	*/
		$data = $this->sales_model->getBarcodeProducts($term,$warehouse_id);
		echo json_encode($data);
	}
	
	public function getProductUseCode($product_id,$warehouse_id){
		$data = $this->sales_model->getProductUseCode($product_id,$warehouse_id);
	...
	*/
	public function receipt($id)
	{
		...
		$data['to_ledger'] = $this->ledger_model->get_single_record($this->branch_model->get_single_record($this->warehouse_model->get_single_record($data['data'][0]->warehouse_id)->branch_id)->ledger_id);
