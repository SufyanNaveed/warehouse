...
class Credit_debit_note extends MY_Controller
{
	...
	public function index(){
		if(!$this->user_model->has_permission("list_credit_debit_note"))
        {
	...
	public function add(){
		if(!$this->user_model->has_permission("add_credit_debit_note"))
        {
            $this->load->view('layout/restricted'); 
        }
        else
	...
	public function addCreditDebitNote(){
        ...
        else
        {
        	...
        	$data 							= array(
												...
												"note_or_refund_voucher_no"		=> $note_or_refund_voucher_no,
												"note_or_refund_voucher_date"	=> $note_or_refund_voucher_date,
												"note_or_refund_voucher_value"	=> $note_or_refund_voucher_value,
												"document_type"					=> $document_type,
												"reason_for_issue_document"		=> $reason_for_issue_document,
												"pre_gst"						=> $pre_gst
											);
	...
	public function edit($id)
	{
		...
		if(!$this->user_model->has_permission("edit_credit_debti_note"))
        {
            $this->load->view('layout/restricted'); 
        }
        else
	...
	*/
	public function delete($id){
		if(!$this->user_model->has_permission("delete_credit_debit_note"))
        {
            $this->load->view('layout/restricted'); 
        }
        else
