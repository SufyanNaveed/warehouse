        ...
        <div class="box">
            ...
            <div class="box-body">
              <form method="post" action="<?php echo base_url('gst_return/gstr2_data') ?>">
                  ...
                  <div class="form-group">
                    ...
                    <select id="month" name="month" class="form-control select2">
                      <?php
                        for($i=1;$i<=12;$i++){
                      ?>
                        <option value="<?php echo sprintf('%02d',intval($i)) ?>" 
                          <?php 
                            if(isset($month))
                            { 
                              if(sprintf('%02d',intval($i)) == $month) 
                              {
                                echo "selected";
                              } 
                            }
                            ...
                            {
                              if(date('m') == sprintf('%02d',intval($i)))
                                echo ' selected';
                            }
                          ?>><?php echo sprintf('%02d',intval($i)) ?></option>
                      <?php
                        }
                      ?>
                    </select>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select id="year" name="year" class="form-control select2">
                      ...
                      ?>
                        <option value="<?php echo sprintf('%04d',intval($i)) ?>" 
                          <?php 
                            if(isset($year))
                            { 
                              if(sprintf('%04d',intval($i)) == $year) 
                              {
                                echo "selected";
                              } 
                            }
                            ...
                            {
                              if(date('Y') == sprintf('%02d',intval($i)))
                                echo ' selected';
                            }
                          ?>><?php echo sprintf('%04d',intval($i)) ?></option>
                      <?php
                        }
                      ?>
                    </select>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <input type="submit" name="submit" value="CSV" class="btn btn-info btn-flat pull-left">
