    ...
    <section class="content">
      ...
      <div class="col-md-12">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" action="<?php echo base_url('gst_return/gstr') ?>">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select id="month" name="month" class="form-control select2">
                      <?php
                        for($i=1;$i<=12;$i++){
                      ?>
                        <option <?php if($i == date('m')) echo " selected";  ?>><?php echo sprintf('%02d',intval($i)) ?></option>
                      <?php
                        }
                      ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select id="year" name="year" class="form-control select2">
                      ...
                      ?>
                        <option <?php if($i == date('Y')) echo " selected";  ?>><?php echo sprintf('%04d',intval($i)) ?></option>
                      <?php
                        }
                      ?>
                    </select>
