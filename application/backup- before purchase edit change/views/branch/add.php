            ...
            <div class="box-body">
              <div class="col-sm-6">
                <form role="form" id="form" method="post" action="<?php echo base_url('branch/addBranch');?>">
                  ...
                  <div class="form-group">
                    <label for="gstin"> GSTIN  <!-- <?php echo $this->lang->line('gstin_label'); ?> --><!-- <span class="validation-color">*</span> --></label>
                    <input type="text" class="form-control" id="gstin" name="gstin" value="<?php echo set_value('gstin'); ?>">
                    <input type="checkbox" name="copy_from_company" id="copy_from_company"> Copy from Company
...
<script>
    ...
    $('#copy_from_company').click(function(){
        if($(this).is(":checked")){

          $.ajax({
              url: "<?php echo base_url('branch/ajax_get_company_setting_record') ?>",
              type: "GET",
              dataType: "TEXT",
              success: function(data){
                //alert(JSON.parse(data)[0].gstin);
                $('#gstin').val(JSON.parse(data)[0].gstin);
              }
          });
        }
    ...
    // $('#copy_from_company').change(function(){
...
<script>
  $(document).ready(function(){
    ...
    var gstin_empty = "Please Enter the GSTIN.";
    var gstin_length = "Please Enter GSTIN with 15 Character";
