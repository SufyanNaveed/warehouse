      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><!-- List Branch --><?php echo "Customers"; ?></h3>
              <a class="btn btn-sm btn-info pull-right" href="<?php echo base_url('customer/add');?>" title="Add New Branch" onclick=""><!-- Add New Branch --> <?php echo $this->lang->line('branch_label_newbranch'); ?></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
