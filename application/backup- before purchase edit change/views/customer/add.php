      ...
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><!-- Add Supplier -->
            <?php echo $this->lang->line('customer_add'); ?>
          </li>
        </ol>
      </h5>    
    </section>
      ...
      <!-- right column -->
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('customer/add');?>">
                  <div class="col-md-6">
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <input type="hidden" id="role_id" name="role_id" value="14">
