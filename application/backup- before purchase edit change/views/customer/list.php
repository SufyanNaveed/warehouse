      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" href="<?php echo base_url('customer/add');?>" title="PDF"> <!-- Add New Suppliers --> 
                ...
                <tbody>
                  <?php 
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url('customer/edit/'); ?><?php echo $id; ?>" title="Edit" class="btn btn-xs btn-info"> <span class="glyphicon glyphicon-edit"></span>
                          </a>
