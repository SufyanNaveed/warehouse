		            	...
		            	<div class="col-sm-12 well well-sm">
			            	<div class="col-sm-4">
			            		...
			            		<div class="col-sm-10">
			            			<b><h4>
			            				<?php 
			            					if(isset($data[0]->customer_first_name)){
			            						echo $data[0]->customer_first_name.' '.$data[0]->customer_last_name;
			            					} 
			            				?>
				            			...
				            			<?php 
			            					if(isset($data[0]->customer_country)){
			            						echo "GSTNO :".$data[0]->customer_gstid;
			            						echo '<br>';
			            					} 
			            				?>
			            	...
			            	<div class="col-sm-4">
			            		...
			            		<div class="col-sm-10">
			            			<b><h4><?php echo $company[0]->name; ?><br/><span style="font-size: 12px;">(Branch Office)</span></h4></b>
				            		...
				            		<br>
				            		<?php echo "GSTNO :".$data[0]->biller_gstid; ?>
				            		<br><br>
			            	...
			            	<div class="col-sm-4">
								...
								<div class="col-sm-10">
				            		...
				            		<br>
				            		<?php echo "GSTIN : ".$company[0]->gstin; ?>
				            		<br>
