  <footer class="main-footer">
    ...
    <strong><?php echo $this->lang->line('dashboard_copyright'); ?> &copy; <?php echo date('Y'); ?> <a href="#">Wehaso Solution Private Limited</a>.</strong> All <?php echo $this->lang->line('dashboard_rights_reserved'); ?>
  </footer>
<!-- ./wrapper -->
<!-- Control Sidebar -->
