                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="amount" name="amount" value='<?php echo ($data[0]->total-$data[0]->paid_amount-$data[0]->flat_discount);?>'  max='<?php echo ($data[0]->total-$data[0]->paid_amount);?>' min="0" step="0.01">
