    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><?php echo "View Purchase Return"; ?></li>
        </ol>
      </h5>    
	      	...
	      	<div class="col-md-12">
		        <div class="box">
		            ...
		            <div class="box-header with-border ">
		              <h3 class="box-title">Order <b>#<?php echo $data[0]->reference_no; ?></b></h3>
		              <?php if($data[0]->paid_amount == 0.00){ ?>
		              	<a class="btn btn-info pull-right" href="<?php echo base_url('purchase_return/receipt/'); ?><?php echo $data[0]->id; ?>" title="Add Payment">Pay Now</a>
			            ...
			            <div class="col-sm-12" style="overflow-y: auto;">
			            	<table class="table table-hover table-bordered">
			            		<thead>
			            			...
			            			<th width="20%" colspan="2"><?php echo $this->lang->line('product_description'); ?></th>
			            		...
			            		<tbody>
			            			...
			            			<tr>
			            				...
			            				<td colspan="2"><?php echo $value->name; ?><br>HSN:<?php echo $value->hsn_sac_code; ?></td>
			            			...
			            			?>
			            			<tr>
			            				<td colspan="9" align="right"><b>Total Value(Excluding Tax & Discount)</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            			...
			            			<tr>
			            				<td colspan="9" align="right"><b>Total Discount</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            				<td align="right" colspan="5"><?php echo $data[0]->discount_value; ?></td>
			            			</tr>
			            			<tr>
			            				<td colspan="9" align="right"><b>IGST</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            				<td align="right" colspan="5"><?php echo $igst;?></td>
			            			</tr>
			            			<tr>
			            				<td colspan="9" align="right"><b>CGST</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            				<td align="right" colspan="5"><?php echo $cgst;?></td>
			            			</tr>
			            			<tr>
			            				<td colspan="9" align="right"><b>SGST</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            				<td align="right" colspan="5"><?php echo $sgst;?></td>
			            			</tr>
			            			<!-- <tr>
			            				<td colspan="9" align="right"><b>General Discount</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            				<td align="right" colspan="5"><?php echo $data[0]->flat_discount;?></td>
			            			</tr> -->
			            			<tr>
			            				<td colspan="9" align="right"><b><?php echo $this->lang->line('purchase_total_amount'); ?>(Including Tax & Discount)</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            ...
			            <div class="col-sm-12">
			            	<div class="buttons">
								<div class="btn-group btn-group-justified">
									<!-- <div class="btn-group">
										<a class="tip btn btn-info tip" href="<?php echo base_url('purchase/email/');?><?php echo $data[0]->id; ?>" title="Email">
									...
									<div class="btn-group">
										<a class="tip btn btn-success" href="<?php echo base_url('purchase_return/pdf/');?><?php echo $data[0]->id; ?>" title="Download as PDF" target="_blank">
									...
									<div class="btn-group">
										<a class="tip btn btn-danger bpo" href="javascript:delete_id(<?php echo $data[0]->id;?>)" title="Delete Purchase" <?php if($data[0]->paid_amount == $data[0]->total){ ?> disabled="disabled" <?php } ?>>
