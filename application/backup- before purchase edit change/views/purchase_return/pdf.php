...
<body>
	...
	<table width="100%" border="1" cellspacing="0" style="border: 0px solid black; border-collapse: collapse;" class="table" cellpadding="2">
			<tr>
				<td colspan="6" style="border: 0px;text-align: right;">Purchase Return Invoice</td>
		...
		<tr style="font-size: 13px;">
			...
			<td valign="top" colspan="4" style="font-size: 13px;">
				Purhcase Invoice No<br>
				<p style="font-size: 13px;font-weight:bold"><?php if(isset($data[0]->purchase_invoice_number)){echo $data[0]->purchase_invoice_number;}?></p>
