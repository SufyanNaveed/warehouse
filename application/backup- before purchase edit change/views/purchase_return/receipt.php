                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" id="invoice" name="invoice" value="<?php echo $data->invoice_no; ?>" readonly>
                          <input type="hidden" id="invoice" name="invoice" value="<?php echo $data->invoice_id; ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" value="<?php echo  $data->branch_name; ?>" readonly>
                          <input type="hidden" id="branch" name="branch" value="<?php echo  $data->branch_id; ?>" readonly>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="customer" name="customer" value="<?php echo $data->first_name." ".$data->last_name; ?>" readonly>
                          </select>
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="amount" name="amount" value='<?php echo $data->total-$data->paid_amount;?>'  max='<?php echo $data->total-$data->paid_amount;?>' min="0" step=".01">
