                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('product/addProduct');?>" encType="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="code" name="code" value="<?php echo set_value('code',time()); ?>">
                    ...
                    <div class="form-group">
                      <label for="subcategory">
                        Select Brand<span class="validation-color">* </span>
                      </label>
                      <a href="" data-toggle="modal" data-target="#brand_model" class="pull-right">+ Add New Brand</a>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="packaging"><?php echo $this->lang->line('product_packaging'); ?> </label>
                      <input type="text" class="form-control" id="packaging" name="packaging" value="<?php echo set_value('packaging'); ?>">
                      <span class="validation-color" id="err_packaging"><?php echo form_error('packaging'); ?></span>
                    </div>
 ...
 <script>
  $(document).ready(function(){
    $("#submit").click(function(event){
      ...
      if(code.indexOf(' ') >= 0){
        $('#err_code').text("Space is not allowed in medicine code.")
        return false;;  
      }
      ...
      if(brand==null || brand==""){
        $("#err_brand").text("Please Select Brand.");
        return false;
      }
      else{
        $("#err_brand").text("");
      ...
      if(name==null || name==""){
        $("#err_name").text("Please Enter Medicine Name.");
        return false;
      }
      else{
        $("#err_name").text("");
