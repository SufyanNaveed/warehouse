        ...
        <div class="col-md-9">
            ...
            <div class="box">
              ...
              ?>
                  ...
                  <a class="btn btn-sm btn-success pull-right btn-flat disabled" style="margin-right: 10px" href="<?php echo base_url('product/import');?>">Import Medicines</a>
                  <a class="btn btn-sm btn-default btn-flat pull-right disabled" style="margin-right: 10px" href="<?php echo base_url('product/products_barcode');?>" onclick="window.open(this.href,'popUpWindow','height=400,width=600,left=10,top=10,,scrollbars=yes,menubar=no'); return false;">Medicines Barcode</a>
            ...
            ?>
                  ...
                  <a class="btn btn-sm btn-success pull-right btn-flat" style="margin-right: 10px" href="<?php echo base_url('product/import');?>">Import Medicines</a>
                  <a class="btn btn-sm btn-default btn-flat pull-right" style="margin-right: 10px" href="<?php echo base_url('product/products_barcode');?>" onclick="window.open(this.href,'popUpWindow','height=400,width=600,left=10,top=10,,scrollbars=yes,menubar=no'); return false;">Medicines Barcode</a>
            <?php      
                }
              }
            ?>    
