                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" id="invoice_type" name="invoice_type" style="width: 100%;">
                          <option value="retail" <?php if($data[0]->invoice_type == "retail") echo ' selected';?>>Retail</option>
                          <option value="wholesale" <?php if($data[0]->invoice_type == "wholesale") echo ' selected';?>>Wholesale</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" id="delivery_person_id" name="delivery_person_id" style="width: 100%;">
                          ...
                          ?>
                              <option value="<?=$row->id?>"
                                <?php 
                                  if($key->id == $data[0]->delivery_person_id)
                                  {
                                    echo "selected";
                                  } 
                                ?>
