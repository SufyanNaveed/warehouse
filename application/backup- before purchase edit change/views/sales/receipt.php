                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="customer" name="customer" value="<?php echo $data[0]->first_name." ".$data[0]->last_name; ?>" readonly>
                          </select>
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="amount" name="amount" value='<?php echo $data[0]->total-$data[0]->paid_amount;?>'  max='<?php echo $data[0]->total-$data[0]->paid_amount;?>' min="0" step=".01">
