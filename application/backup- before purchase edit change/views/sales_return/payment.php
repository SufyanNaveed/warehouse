                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="hidden" id="invoice" name="invoice" value="<?php echo $data->receipt_voucher_no; ?>">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="amount" name="amount" value='<?php echo ($data->total-$data->paid_amount-$data->flat_discount);?>'  max='<?php echo ($data->total-$data->paid_amount);?>' min="0" step="0.01">
