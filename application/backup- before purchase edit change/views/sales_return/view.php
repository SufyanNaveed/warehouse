    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('sales'); ?>"><?php echo "sales return"; ?></a></li>
          <li class="active"><?php echo "sales return details"; ?></li>
        </ol>
      </h5>    
    </section>
    <!-- Main content -->
	      	...
	      	<div class="col-md-12">
		        <div class="box">
		            <div class="box-header with-border">
		              <h3 class="box-title"><?php echo "Sales Return Details"; ?></h3>
		              <?php 
		              if (isset($data[0]->paid_amount)) 
		              {		              
		              
		              if($data[0]->paid_amount == 0.00){ ?>
		              	<a class=" btn btn-info pull-right btn-flat" href="<?php echo base_url('sales_return/payment/'); ?><?php echo $data[0]->id; ?>" title="Add Payment">Pay Now</a>
		              <?php }elseif($data[0]->paid_amount < $data[0]->total){ ?>
                          <a class=" btn btn-info pull-right btn-flat" href="<?php echo base_url('sales_return/payment/'); ?><?php echo $data[0]->id; ?>" title="Add Payment">Pay Now</a>
                      <?php }else{ ?>
		              	<button class="btn btn-success pull-right btn-flat">Paid</button>
		              <?php }  }?>
		              <!-- <a href="<?php echo base_url('sales/pos/');?><?php echo $data[0]->id; ?>" class="btn btn-success pull-right btn-flat">POS</a> -->

		              <a href="JavaScript:newPopup('<?php echo base_url('sales/pos/');?><?php echo $data[0]->id; ?>');" class="btn btn-success pull-right btn-flat" >POS</a>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		            	<div class="col-sm-12 well well-sm">
			            	<div class="col-sm-4">
			            		...
			            		<div class="col-sm-10">
			            			<b><h4>
			            				<?php 
			            					if(isset($customer[0]->first_name)){
			            						echo $customer[0]->first_name." ".$customer[0]->last_name;
			            					} 
			            				?>
				            		...
				            		<br>
				            			<?php 
			            					if(isset($customer[0]->ctname)){
			            						echo $customer[0]->ctname;
			            					} 
			            				?>
		            				<br>
				            			<?php 
			            					if(isset($customer[0]->state_name)){
			            						echo $customer[0]->state_name;
			            					} 
			            				?>
				            		<br>
				            			<?php 
			            					if(isset($customer[0]->cname)){
			            						echo $customer[0]->cname;
			            					} 
			            				?>
				            		<br>
				            		<br>
				            			<?php 
			            					if(isset($customer[0]->phone)){
			            						echo $this->lang->line('purchase_mobile')." : ".$customer[0]->phone;
			            					} 
			            				?>
				            		<br>
				            			<?php 
			            					if(isset($customer[0]->email)){
			            						echo $this->lang->line('company_setting_email')." : ".$customer[0]->email;
			            					} 
			            				?>
			            		</div>
			            	</div>
			            ...
			            <div class="col-sm-12">
			            	<div class="buttons">
								<div class="btn-group btn-group-justified">
									<div class="btn-group">
										<a class="tip btn btn-info tip" href="<?php echo base_url('sales_return/email/'); ?><?php echo $data[0]->id; ?>" title="Email">
											<i class="fa fa-envelope-o"></i>
											<span class="hidden-sm hidden-xs"><?php echo $this->lang->line('company_setting_email'); ?></span>
										</a>
									</div>
									<div class="btn-group">
										<a class="tip btn btn-success" href="<?php echo base_url('sales_return/pdf/');?><?php echo $data[0]->id; ?>" title="Download as PDF" target="_blank">
											<i class="fa fa-download"></i>
											<span class="hidden-sm hidden-xs"><?php echo $this->lang->line('product_alert_pdf'); ?></span>
										</a>
									</div>
									<div class="btn-group">
										<a class="tip btn btn-success" href="<?php echo base_url('sales_return/print1/');?><?php echo $data[0]->id; ?>" title="Download as PDF" target="_blank">
											<i class="fa fa-download"></i>
									...
									<?php if($data[0]->paid_amount == 0.00){ ?>
									<div class="btn-group">
										<a class="tip btn btn-warning tip" href="<?php echo base_url('sales_return/edit/'); ?><?php echo $data[0]->id; ?>" title="Edit">
									...
									<?php } ?>
									<div class="btn-group">
										<a class="tip btn btn-danger bpo" <?php if($data[0]->paid_amount == $data[0]->total){ ?> disabled="disabled" <?php } ?> href="javascript:delete_id(<?php echo $data[0]->id;?>)" title="Delete Purchase">
