...
class Delivery_person extends MY_Controller
{
	...
	public function index(){
		if(!$this->user_model->has_permission("list_delivery_person"))
        {
        ...
        else
        {
			...
			$data['data'] = $this->user_model->get_user_records_by_role('delivery_person');
			$this->load->view('delivery_person/list',$data);
		}
	} 
	/*
	...
	*/
	...
	public function add()
	{
		if(!$this->user_model->has_permission("add_delivery_person"))
        {
            $this->load->view('layout/restricted'); 
        }
        else
        {
			...
			if($this->input->server('REQUEST_METHOD') === 'POST'){
				...
				if($this->form_validation->run()==FALSE){
					$this->load->view('delivery_person/add');
				}
				else{
		            ...
		            if($id = $this->ion_auth->register($identity, $password, $email, $additional_data,$groupData))
		            {
						...
						$this->session->set_flashdata('success', 'Delivery Person has been added successfully.');
						redirect("delivery_person",'refresh');
		            }
		            else
		            {
		            	$this->session->set_flashdata('failure', 'We got problem while creating Delivery Person.');
						redirect("delivery_person",'refresh');
		            }
				}
				...
				$this->load->view('delivery_person/add',$data);
			}
		}
	}
	...
	public function edit($id = NULL)
	{
		...
		if(!$this->user_model->has_permission("edit_delivery_person"))
        {
            $this->load->view('layout/restricted'); 
        }
        else
        {
			if($this->input->server('REQUEST_METHOD') === 'POST'){
				...
				if($this->form_validation->run()==FALSE){
					...
					$this->load->view('delivery_person/edit');
				}
				else{
		            ...
		            if($this->ion_auth->update($id, $data))
		            {
		            	...
		            	$this->session->set_flashdata('success', 'Delivery Person has been updated successfully.');
						redirect("delivery_person",'refresh');
		            }
		            else
		            {
		            	$this->session->set_flashdata('failure', 'We got problem while updating Delivery Person.');
						redirect("delivery_person",'refresh');
		            }
				}
			}
			else
			{
				...
				if($data['data']->state_id != "")
					...
					$data['city']  = array();
				$this->load->view('delivery_person/edit',$data);
			}
		}
	}
	...
	public function delete($id){
		...
		if(!$this->user_model->has_permission("delete_delivery_person"))
        {
            $this->load->view('layout/restricted'); 
        }
        else
        {
			if($this->ion_auth_model->deactivate($id)){
				$this->session->set_flashdata('success', 'Delivery Person deleted successfully.');
				redirect("delivery_person",'refresh');
			}else{
				$this->session->set_flashdata('failure', 'We got problem while creating Delivery Person.');
				redirect("delivery_person",'refresh');
